...
def transfer_to_store_info_from_dm_order_item_dag():
    ...
    def transfer_data_to_store_info(last_time: datetime):
        ...
        insert_sql = """
            INSERT INTO info_mart.store_info (time_start_interval, dim_store_id, name, total_quantity, 
                ...
                FROM
                    ...
                    JOIN dm_order_item.dim_store d_s USING (dim_store_id)
                WHERE 
                    f_oi.order_dt > %(last_time)s
                GROUP BY 
                    f_oi.dim_store_id, d_s.name, time_start_inerval
                ORDER BY 
                    time_start_inerval;
        """
    ...
    transfer_data_to_store_info(last_time)

transfer_to_store_info_from_dm_order_item_dag()
